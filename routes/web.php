...
Route::group([
	...
	Route::group([
		...
		CRUD::resource('custom_fields/{postTypeFieldId}/post_types', 'PostTypeFieldController');
...
Route::group([
	...
	Route::group(['middleware' => ['web']], function ($router) {
		...
		Route::group(['prefix' => 'ajax'], function ($router) {
			...
			Route::post('post_type/custom-fields', 'Ajax\PostTypeController@getCustomFields');
