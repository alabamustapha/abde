...
trait CustomFieldTrait
{
    ...
    /**
     * Get Post type's Custom Fields Buffer
     *
	 * @param $postTypeId
	 * @param $languageCode
	 * @param null $errors
	 ...
	 * @return string
	 */
    public function getPostTypeFieldsBuffer($postTypeId, $languageCode, $errors = null, $oldInput = null, $postId = null)
    {
        $html = '';
        
        $fields = PostTypeField::getFields($postTypeId, $postId, $languageCode);
