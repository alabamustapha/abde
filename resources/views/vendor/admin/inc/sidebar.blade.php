	...
	<aside class="main-sidebar" id="adminSidebar">
		...
		<section class="sidebar">
			...
			<ul class="sidebar-menu">
				...
				<li class="treeview">
					<a href="#"><i class="fa fa-group"></i> <span>{{ trans('admin::messages.users_roles_permission') }}</span><i class="fa fa-angle-left pull-right"></i></a>
					<ul class="treeview-menu">
						@if (auth()->user()->can('list-user') || userHasSuperAdminPermissions())
						<li><a href="{{ admin_url('users') }}"><i class="fa fa-user"></i> <span>{{ trans('admin::messages.users') }}</span></a></li>
						@endif
