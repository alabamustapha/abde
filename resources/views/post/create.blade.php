							...
							<div class="col-sm-12">
								...
								<form class="form-horizontal" id="postForm" method="POST" action="{{ url()->current() }}" enctype="multipart/form-data">
									...
									<fieldset>
										...
										<!-- price -->
										<input id="price" name="price" class="form-control" placeholder="{{ t('e.i. 15000') }}" type="hidden" value="100">
													
										<input id="negotiable" name="negotiable" type="hidden" value="1" {{ (old('negotiable')=='1') ? 'checked="checked"' : '' }}>
										...
										*/
										...
										<!-- contact_name -->
										<input id="contact_name" name="contact_name" type="hidden" value="{{ 'Admin admin' }}">
										<input id="email" name="email" type="hidden" value="{{ 'dummy@gmail.com' }}">
										<!-- @if (auth()->check())
										...
										?> -->
										<!-- phone -->
										<input id="phone" name="phone" type="hidden" value="{{ '08000000092' }}"
										<input name="phone_hidden" id="phoneHidden" type="hidden" value="1" checked>
